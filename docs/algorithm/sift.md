...
3. 相邻层尺度比例关系：`σ, kσ, k²σ, ..., k^(S-1)σ`，其中 k = 2^(1/S)
4. 每组图像尺寸是前一组的一半（降采样）
...
**尺度空间层数示意：**
```
Octave 1: σ₀, kσ₀, k²σ₀, k³σ₀, k⁴σ₀, k⁵σ₀  (6层)
Octave 2: 2σ₀, 2kσ₀, 2k²σ₀, 2k³σ₀, 2k⁴σ₀, 2k⁵σ₀  (6层)
...
```
...
1. 对尺度空间每组的相邻层做差分
2. 得到DoG金字塔：`D(x, y, σ) = L(x, y, kσ) - L(x, y, σ)`
3. DoG金字塔层数 = 尺度空间层数 - 1
